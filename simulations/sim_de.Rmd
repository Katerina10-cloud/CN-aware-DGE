...
We construct a simulated dataset of Negative Binomial data from two conditions (tumor vs normal) by inroducing CN multiplicative effect and additive effect coming from other source in order to simulate DGE.
...
### Estimate parameters from TCGA-BRCA dataset: mean and variance

# Formatting RNA counts dataset #
load("/Users/katsiarynadavydzenka/Documents/PhD_AI/TCGA/breast_cancer/data/brca_rna_normal.Rdata")
brca_rna_normal <- brca_rna_normal[,1:40]
brca_rna_normal <- brca_rna_normal[c(1:11538,12000:12500),]
letters <- c(1:12039)
...
#### Volcano plot of CN induced DGE
```{r}
res_apeglm$diffexpressed <- "NO"
res_apeglm$diffexpressed[res_apeglm$log2FoldChange >= 1.0 & res_apeglm$padj < 0.05] <- "UP"
res_apeglm$diffexpressed[res_apeglm$log2FoldChange <= -1.0 & res_apeglm$padj < 0.05] <- "DOWN"

...
res_aware <- res_aware_pydeseq %>% dplyr::select(logFC, padj, isDE, DEtype, tumor_type, method, cnv_mean) 
res_naive <- res_naive_pydeseq %>% dplyr::select(logFC, padj, isDE, DEtype, tumor_type, method, cnv_mean)
...
res_naive <- res_naive_pydeseq %>% dplyr::select(DEtype) %>% dplyr::rename(CN_naive = DEtype)
res_aware <- res_aware_pydeseq %>% dplyr::select(DEtype) %>% dplyr::rename(CN_aware = DEtype)
